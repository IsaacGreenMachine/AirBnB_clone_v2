...
def nummyTemp(n):
    """displays on any child of number_template if number"""
    try:
        return flask.render_template('5-number.html', num=int(n))
    except Exception:
        flask.abort(404)
...
def nummyOddEven(n):
    """displays on any child of number_odd_or_even"""
    try:
        return flask.render_template('6-number_odd_or_even.html', num=int(n))
    except Exception:
        flask.abort(404)
